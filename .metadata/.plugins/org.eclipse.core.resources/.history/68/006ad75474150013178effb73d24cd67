...
public class Login extends HttpServlet {
	...
	public static class DatabaseManager{
		...
		public static String productsStockQuery(String name){
			return "SELECT * FROM products WHERE name ='" + name + "' AND stock > 0;";
		}
		private static String decreaseProductStock(String name) {
			return "UPDATE products SET stock = stock - 1 WHERE name = '" + name + "';";
		}
	}
	...
	private boolean register(String log, String pass) {
		return DatabaseManager.register(log, pass);
	}
